import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from './runtime_Cjrs9xjV.mjs';

const schema = {"APP_URL":{"context":"server","access":"secret","type":"string"},"BONSAI_URL":{"context":"server","access":"secret","type":"string"},"BONSAI_USERNAME":{"context":"server","access":"secret","type":"string"},"BONSAI_PASSWORD":{"context":"server","access":"secret","type":"string"},"IMAGE_SERVICE":{"context":"client","access":"public","type":"string"},"INTERNAL_API_KEY":{"context":"client","access":"public","type":"string"}};
...
setOnSetGetEnv(() => {
	APP_URL = _internalGetSecret("APP_URL");
BONSAI_URL = _internalGetSecret("BONSAI_URL");
BONSAI_USERNAME = _internalGetSecret("BONSAI_USERNAME");
BONSAI_PASSWORD = _internalGetSecret("BONSAI_PASSWORD");

});
let APP_URL = _internalGetSecret("APP_URL");
let BONSAI_URL = _internalGetSecret("BONSAI_URL");
let BONSAI_USERNAME = _internalGetSecret("BONSAI_USERNAME");
let BONSAI_PASSWORD = _internalGetSecret("BONSAI_PASSWORD");

export { APP_URL as A, BONSAI_URL as B, BONSAI_USERNAME as a, BONSAI_PASSWORD as b };
